    ...
    <li>
        ...
        <ol type="a">
            ...
            <li>
                ...
                <pre># echo "deb http://research.cs.wisc.edu/htcondor/debian/8.8/stretch stretch contrib" >> /etc/apt/sources.list
# echo "deb-src http://research.cs.wisc.edu/htcondor/debian/8.8/stretch stretch contrib" >> /etc/apt/sources.list</pre>
            </li>
        </ol>
    </li>
    <li>
