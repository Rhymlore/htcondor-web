---
layout: default
title: HTCondor - Install Instructions - Ubuntu 16 Stable
---
    ...
    <li>
        ...
        <ol type="a">
            ...
            <li>
                ...
                <pre># echo "deb http://research.cs.wisc.edu/htcondor/ubuntu/8.8/xenial xenial contrib" >> /etc/apt/sources.list
# echo "deb-src http://research.cs.wisc.edu/htcondor/ubuntu/8.8/xenial xenial contrib" >> /etc/apt/sources.list</pre>
            </li>
        </ol>
    </li>
    <li>
