...
<figure>
  <img src="{{ '/assets/images/banq-mw.png' | relative_url }}" alt="Newspaper spread"/>
...
<figure class="figure float-right" style="margin-left: 1em">
  <img src="{{site.baseurl}}/assets/images/banq-patrie.png" class="figure-img img-fluid rounded" alt="Cover of La Patrie Newspaper" width="350px">
